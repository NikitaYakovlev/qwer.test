...
## Overrides {#overrides}
The `./first/scss/_default-variables.scss` file is generally where you will
...
The `./first/scss/overrides.scss` file contains various Drupal overrides to
properly integrate with the [Bootstrap Framework]. It may contain a few
enhancements, feel free to edit this file as you see fit.

The `./first/scss/style.scss` file is the glue that combines:
...
that you should compile to `./first/css/style.css` (note the same file
