...
Replace all of the following instances of `first` with the actual machine
name of your sub-theme.

Create a file at
`./first/src/Plugin/Setting/first/Accessibility/SkipLink.php`
with the following contents:

```php
<?php
namespace Drupal\first\Plugin\Setting\first\Accessibility;

use Drupal\bootstrap\Plugin\Setting\SettingBase;

/**
 * The "first_skip_link_id" theme setting.
 *
 * @ingroup plugins_setting
 *
 * @BootstrapSetting(
 *   id = "first_skip_link_id",
 *   type = "textfield",
...
```twig
<a href="#{{ theme.settings.first_skip_link_id }}"
...
```twig
<a id="{{ theme.settings.first_skip_link_id }}"></a>
```
